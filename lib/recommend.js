 ...
 * batch requests.
 */
export const buildRecommendations = async ({ core, limit, dismissedIds, seeded, algorithm = {} }) => {
  const papers = core;
  ...
  let citationEdges = new Map();
  if (seedIds.length) citationEdges = await fetchCitationIds(seedIds);
